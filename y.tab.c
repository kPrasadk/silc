...
#line 48 "lex.y" /* yacc.c:1646  */
    {char num[40]; sprintf (num, "%d", (yyvsp[0].number)); (yyval.text)=strdup(num); }
#line 1240 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 50 "lex.y" /* yacc.c:1646  */
    {char rep[100]; sprintf (rep, "+ %s %s", (yyvsp[-2].text), (yyvsp[0].text)); (yyval.text)=strdup(rep); }
#line 1246 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 52 "lex.y" /* yacc.c:1646  */
    { char rep[100]; sprintf (rep, "- %s %s", (yyvsp[-2].text), (yyvsp[0].text)); (yyval.text)=strdup(rep); }
...
#line 1258 "y.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 56 "lex.y" /* yacc.c:1646  */
    { char rep[100]; sprintf (rep, "/ %s %s", (yyvsp[-2].text), (yyvsp[0].text)); (yyval.text)=strdup(rep);  }
#line 1264 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 58 "lex.y" /* yacc.c:1646  */
